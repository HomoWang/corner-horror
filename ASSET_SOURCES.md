...
| 執行檔案（`public/assets/corridor-preview/`） | 來源 | 授權 | 用途 |
|---|---|---|---|
| `cabinet-rust-diff-1k.jpg` | Poly Haven `rusty_metal_03`（Amal Kumar）Diffuse 1k | CC0 | 走廊消防箱鐵件（捲盤軸、支架、警鈴等）：程式內重新上色為焦黑鐵 |
| `cabinet-rust-normal-gl-1k.jpg` | 同上 Normal (GL) 1k | CC0 | 鐵件與捲盤表面凹凸 |
...
Poly Haven 來源頁：https://polyhaven.com/a/rusty_metal_03
